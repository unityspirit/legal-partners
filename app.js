// ============================================================
//  LEXIS PARTNERS — app.js   (ScrollCanvas Engine v3)
...
loaderEl.innerHTML = `
  <div class="loader-inner">
    <img src="images/logo.svg" alt="LEXIS PARTNERS" style="width:112px;height:112px;object-fit:contain;border-radius:10px;margin-bottom:8px">
    <div class="loader-logo">LEXIS PARTNERS</div>
...
if (form) {
  form.addEventListener('submit', e => {
    ...
    btn.innerHTML = '✓ Столик забронирован!';
    btn.style.background = 'linear-gradient(135deg,#2dd4a8,#1fa882)';
    btn.style.color = '#fff';
    setTimeout(() => {
      btn.innerHTML = 'Забронировать <span class="btn-arrow">→</span>';
